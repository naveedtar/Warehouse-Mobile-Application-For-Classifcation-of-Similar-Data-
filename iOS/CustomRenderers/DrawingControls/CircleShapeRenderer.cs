...
using CoreGraphics;
using WarehouseHandheld.Elements.DrawingControls;
using UIKit;
using WarehouseHandheld.iOS.CustomRenderers.DrawingControls;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;


[assembly: ExportRenderer(typeof(CircleShape), typeof(CircleShapeRenderer))]
namespace WarehouseHandheld.iOS.CustomRenderers.DrawingControls
{
